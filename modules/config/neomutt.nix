...
#     xdg.configFile."neomutt/colors".source = ./config/mutt/config/colors;

#     xdg.configFile."neomutt/view_attachment.sh".source = ./config/mutt/config/view_attachment.sh;
#     xdg.configFile."neomutt/view_attachment.sh".executable = true;

#     xdg.configFile."neomutt/mailcap".source = ./config/mutt/config/mailcap;
#     xdg.configFile."neomutt/mailcap_reply".source = ./config/mutt/config/mailcap_reply;
#   };
# }
