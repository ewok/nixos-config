...
in
{
  config = mkIf (dev.enable && gui.enable) {
    ...
    home-manager.users."${username}" = {
      ...
      xdgConfig.file."Zeal/Zeal.conf".text = ''
        [General]
        ...
        custom_css_file=
        dark_mode=true
        default_fixed_font_size=${gui.fonts.monospaceFontSize}
        ...
        fixed_font_family=${gui.fonts.monospaceFont}
        ...
        [docsets]
        path=${homeDirectory}/.local/share/Zeal/Zeal/docsets
